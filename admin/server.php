...
return [
    'exceptions' => [
        ...
        'bad_variable' => 'Houve um erro de validação com o :name variável.',
        'daemon_exception' => 'Houve uma exceção ao tentar se comunicar com o daemon, resultando em um código de resposta de código HTTP /:. Esta exceção foi registrada. ',
        'default_allocation_not_found' => 'A alocação padrão solicitada não foi encontrada nas alocações deste servidor. ',
    ],
    'alerts' => [
        'startup_changed' => 'A configuração de inicialização deste servidor foi atualizada. Se o ninho ou ovo deste servidor foi alterado, uma reinstalação estará ocorrendo agora. ',
        ...
        'server_reinstalled' => 'Este servidor está na fila para uma reinstalação que começa agora. ',
        'details_updated' => 'Os detalhes do servidor foram atualizados com sucesso. ',
        'docker_image_updated' => 'Alterou com sucesso a imagem padrão do Docker para usar neste servidor. É necessária uma reinicialização para aplicar esta alteração. ',
